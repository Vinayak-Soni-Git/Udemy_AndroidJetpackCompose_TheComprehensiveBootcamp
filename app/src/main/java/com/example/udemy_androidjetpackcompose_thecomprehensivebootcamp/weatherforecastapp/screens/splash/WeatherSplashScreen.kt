package com.example.udemy_androidjetpackcompose_thecomprehensivebootcamp.weatherforecastapp.screens.splash
...
fun WeatherSplashScreen(navController: NavController){
    ...
    Surface(
        ...
        Column(modifier = Modifier.padding(1.dp),
            ...
            Text(text = "Find the Sun?", style = MaterialTheme.typography.headlineSmall,
